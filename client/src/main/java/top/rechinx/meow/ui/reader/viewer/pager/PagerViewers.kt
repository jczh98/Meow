...
class L2RPagerViewer(activity: ReaderActivity,
                     preferenceHelper: PreferenceHelper) : PagerViewer(activity, preferenceHelper) {

    override fun createPager(): Pager = Pager(activity)

}

class R2LPagerViewer(activity: ReaderActivity,
                     preferenceHelper: PreferenceHelper): PagerViewer(activity, preferenceHelper) {
