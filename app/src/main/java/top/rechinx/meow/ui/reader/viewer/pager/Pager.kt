...
import top.rechinx.meow.ui.reader.viewer.GestureDetectorWithLongTap
 ...
 */
open class Pager(context: Context,
                 isHorizontal: Boolean = true): DirectionalViewPager(context, isHorizontal) {
