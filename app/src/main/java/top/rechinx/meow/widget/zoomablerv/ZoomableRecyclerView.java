...
public class ZoomableRecyclerView extends RecyclerView implements OnScaleDragGestureListener,
    ...
    public void onFling(float startX, float startY, float velocityX, float velocityY) {
        ...
        mCurrentFlingRunnable.fling(rect, Utility.getViewWidth(this),
                Utility.getViewHeight(this), (int) velocityX, (int) velocityY);
    ...
    public boolean onDoubleTap(MotionEvent event) {
        if (isDoubleTap) {
            try {
                float scale = Utility.calculateScale(mMatrix);
                float x = event.getX();
                float y = event.getY();
    ...
    public void checkBounds() {
        ...
        int viewHeight = Utility.getViewHeight(this);
        ...
        int viewWidth = Utility.getViewWidth(this);
